...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"AccountVault.MainWindow"))
    {
        return winrt_make_AccountVault_MainWindow();
    }

    if (requal(name, L"AccountVault.XamlMetaDataProvider"))
    {
        return winrt_make_AccountVault_XamlMetaDataProvider();
    }
