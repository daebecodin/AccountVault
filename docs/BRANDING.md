...
User-facing text may use Account Armory. Do not casually rename `AccountVault`
identifiers: the C++/WinRT namespace, XAML/IDL classes, project, executable,
package entry point, and generated files depend on them.
